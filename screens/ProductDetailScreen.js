...
const ProductDetailScreen = ({ route, navigation }) => {
  ...
  const renderRelatedProduct = (item) => (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.replace("ProductDetail", { productId: item.id, storeId })
      }
    >
      <Image
...
const styles = StyleSheet.create({
  ...
  productName: { fontSize: 24, fontWeight: "bold", color: "#212121", marginBottom: 5 },
  productUnit: { fontSize: 16, color: "#757575", marginBottom: 5 },
  productPrice: { fontSize: 20, fontWeight: "bold", color: "#4CAF50" },
  ...
  quantityText: { fontSize: 16, fontWeight: "bold", color: "#212121", marginHorizontal: 15 },

  /* Secciones */
  sectionContainer: { marginBottom: 20 },
  sectionTitle: { fontSize: 18, fontWeight: "bold", color: "#212121", marginBottom: 10 },
  descriptionText: { fontSize: 14, color: "#757575", lineHeight: 22 },
  ...
  detailValue: { fontSize: 14, color: "#212121" },
  ...
  nutritionValue: { fontSize: 14, fontWeight: "bold", color: "#212121", marginBottom: 5 },
  nutritionLabel: { fontSize: 12, color: "#757575" },
  ...
  relatedProductName: { fontSize: 14, fontWeight: "bold", color: "#212121", marginBottom: 5 },
  relatedProductPrice: { fontSize: 12, color: "#4CAF50" },
  ...
  totalLabel: { fontSize: 12, color: "#757575" },
  totalPrice: { fontSize: 18, fontWeight: "bold", color: "#212121" },
  ...
  addToCartText: { fontSize: 16, fontWeight: "bold", color: "#FFFFFF", marginLeft: 10 },
});
